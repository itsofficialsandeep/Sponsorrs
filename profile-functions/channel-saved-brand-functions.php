...
if (isset($_POST['actionType'])) {
    ...
    if ($_POST['actionType'] == 1) { // unfollow brand
        ...
        $sql = "DELETE FROM saved_brand_profiles WHERE saver_channel_id='$currentUser' AND saved_brand_id='$brand'";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<tr id="' . $id_company . '">
							...
							<!-- Table data -->
							<td>' . industryCodeToName($conn, $industry) . '</td>
							...
							<td>
								...
								<button class="btn btn-danger-soft btn-round mb-0" data-bs-toggle="tooltip"
									data-bs-placement="top" title="Remove" id="b' . $id_company . '" value="#' . $id_company . '" onclick="removeRequest(this.value,' . $id_company . ')"><i class="bi bi-person-dash-fill" ></i></button>
							</td>
						</tr>';
                }
            } else {
