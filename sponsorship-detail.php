...
$currentUser = mysqli_real_escape_string($conn, $currentUser);

$sponsorship_id = $_GET['sid'];
$sponsorship_id = mysqli_real_escape_string($conn, $sponsorship_id);
...
if ($result->num_rows > 0) {
	while ($row = $result->fetch_assoc()) {
		$sponsorship_id = $row['spos$sponsorship_id'];
		$subcreation_id = $row['subcreation_id'];
		$id_company = $row['id_company'];
		$sponsorship_title = $row['sponsorship_title'];
		$description = $row['description'];
		$soffer_price = $row['soffer_price'];
		$service = $row['service'];
		$adtype = $row['adtype'];
...
// for APPLY button
$token = $primary_ac_id . "|" . $subcreation_id . "|" . $sponsorship_id . '|' . hash("sha512", $tokenSecret . $_SESSION['current_user']);
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="d-flex justify-content-between ">
							...
							<!-- Badge -->
							<button data-action="applyTheSponsorship" data-token="<?php echo $token; ?>"
								class="apply_sponsorships me-2 btn btn-primary mb-3 rounded-2 fs-5"
								id="applyToChannel"><?php echo $appliedOrNot; ?></button>
							<button
								class="d-none me-2 btn btn-lg btn-warning mb-3 font-base py-2 px-4 rounded-2 d-inline-block">Follow</button>
							<button data-action="saveTheSponsorship"
								data-token="<?php echo $primary_ac_id . '|example'; ?>" id="saveBrands"
								class="save_sponsorships btn btn-success mb-3 rounded-2 fs-5"><?php echo $saved; ?></button>
						</div>
						<!-- Content -->
							...
							<div class="card-body p-4">
								<div class="tab-content pt-2" id="course-pills-tabContent">
									...
									<div class="tab-pane fade show active" id="course-pills-1" role="tabpanel"
											...
											<div class="row g-0 align-items-center">
												...
												<div class="col-md-7">
													...
													<div class="card-body">
														...
														<div class="dropdown list-inline-item" style="margin-left:20px">
															...
															<ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded"
																...
																<li><a class="dropdown-item"
																		href="https://twitter.com/intent/tweet?url=https://www.sponsorrs.com/sponsorship-detail.php?sid=<?php echo $sponsorship_id; ?>&text=Sponsorrs.com helps influencer get sponsorships with least effort."><i
																			class="bi bi-twitter text-twitter me-2"></i>Twitter</a>
																</li>
																<li><a class="dropdown-item"
																		href="https://www.facebook.com/sharer/sharer.php?u=https://www.sponsorrs.com/sponsorship-detail.php?sid=<?php echo $sponsorship_id; ?>"><i
																			class="fab fa-facebook text-facebook me-2"></i>Facebook</a>
																</li>
																<li><a class="dropdown-item"
																		href="https://twitter.com/intent/tweet?url=https://www.sponsorrs.com/sponsorship-detail.php?sid=<?php echo $sponsorship_id; ?>&text=Business profile of <?php echo $title; ?>"><i
																			class="fab fa-linkedin text-linkedin me-2"></i>LinkedIn</a>
																</li>
																<li><a class="dropdown-item"
																		href="https://www.linkedin.com/sharing/share-offsite/?url=https://www.sponsorrs.com/sponsorship-detail.php?sid=<?php echo $sponsorship_id; ?>"><i
														...
														<ul class="list-inline d-flex align-item-center mt-3"
															style="height:30px">
															<div title="AdCategory of the sponsorship"
																class="d-flex align-items-center me-3 mb-2  align-self-center ">
																<span
																	class="bg-opacity-15 text-primary  align-self-center"><i
																		class="icon-xl bi bi-box-fill"></i></span>
																<span class="fw-bolder h6 fw-light mb-0 ms-2">
																	<?php $service = $service == 1 ? "Service" : "Product";
																	echo $service; ?>
																</span>
															</div>
															<div title="AdCategory of the sponsorship"
																...
																<span
																	class="bg-opacity-15 text-primary  align-self-center"><i
																		class="icon-xl bi bi-hash"></i></span>
																<span class="fw-bolder h6 fw-light mb-0 ms-2">
																	<?php echo adtypeNumToString($adtype); ?>
																</span>
															</div>
															<div title="AdCategory of the sponsorship"
																class="d-flex align-items-center me-3 mb-2  align-self-center ">
																...
																<span class="fw-bolder h6 fw-light mb-0 ms-2">
																	<?php echo adcategoryNumToString($adcategory); ?>
																</span>
															</div>
														</ul>
														<hr>
										...
										<h5 class="mb-3">Sponsorship description</h5>
					...
					<div class="col-lg-4 pt-5 pt-lg-0">
						<div class="col-md-6 col-lg-12">
							...
							<div class="card card-body shadow p-4 mb-4">
								<!-- Title -->
								<h4 class="mb-3">More about the brand..</h4>
								<ul class="list-group list-group-borderless">
									<li class="list-group-item d-flex justify-content-between align-items-center">
										<span class="h6 fw-light mb-0"><i
												class="bi bi-building-fill text-primary"></i>Industry</span>
										<span>
											<?php echo $industry; ?>
										</span>
									</li>
