    ...
    <nav class="navbar navbar-expand-xl">
        <div class="container-fluid px-3 px-xl-5">
            ...
            <a class="navbar-brand" href="index.php">
                ...
                <img class="dark-mode-item navbar-brand-item" src="assets/images/sponsorrs.png" alt="logo">
            </a>
            <!-- Logo ENnD -->
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <li class="nav-item dropdown dropdown-menu-shadow-stacked">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="categoryMenu">
                            <li> <a class="dropdown-item" href="https://www.sponsorrs.com">Home</a></li>
                            <li> <a class="dropdown-item" href="brands.php">Brands</a></li>
                            <li> <a class="dropdown-item" href="sponsorships.php">Sponsorships</a></li>
                            <li> <a class="dropdown-item" href="creators.php">Creators</a></li>
                            <li> <a class="dropdown-item" href="search.php">Search</a></li>
                            <li> <a class="dropdown-item" href="account.php">Signup/Sign-In</a></li>
                            <li> <a class="dropdown-item" href="c/channel-profile.php?page=dashboard">Channel
                                    Profile</a></li>
                            ...
                            <li> <a class="dropdown-item" href="contact-us.php">About/Contact-Us</a></li>
                            <li> <a class="dropdown-item" href="data-privacy-policy.php">Data Privacy Policy</a></li>
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <li class="nav-item dropdown" style="display: none;">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="demoMenu">
                            ...
                            <li> <a class="dropdown-item" href="index-10.html">Home School</a>
                            <li>
                    ...
                    <li class="nav-item mr-3" style="margin-right: 10px;">
                        <a class="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0"
                            href="creators.php" id="categoryMenu" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"><span>Creators</span></a>
                    </li>
                    <li class="nav-item mr-3" style="margin-right: 10px;">
                        <a class="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0"
                            href="brands.php" id="categoryMenu" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"><span>Brands</span></a>
                    </li>
                    <li class="nav-item mr-3" style="margin-right: 10px;">
                        <a class="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0"
                            href="sponsorships.php" id="categoryMenu" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"><span>Sponsorships</span></a>
                    </li>
                    <li class="nav-item mr-3" style="margin-right: 10px;">
                        <a class="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0"
                            href="pricing.php" id="categoryMenu" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"><span>Pricing</span></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0"
                            href="search.php" id="categoryMenu" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"><span>Search</span></a>
                    </li>
                    ...
                    <li class="nav-item dropdown" style="display: none;">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    <li> <a class="dropdown-item" href="docs/snippet-hero-12.html">Hero Form</a>
                                    </li>
                            ...
                            <li> <a class="dropdown-item" href="event-detail.html">Event Detail <span
                    ...
                    <li class="nav-item dropdown dropdown-fullwidth" style="display: none;">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" data-bs-popper="none">
                            <div class="row p-4 g-4">
                                ...
                                <!-- Dropdown column item -->
                                <div class="col-xl-6 col-xxl-3">
                                    <h6 class="mb-0">Download Sponsorrs</h6>
                                    <hr>
                                    <!-- Image -->
                        ...
                        <ul class="dropdown-menu dropdown-menu-end min-w-auto" data-bs-popper="none">
                            ...
                            <li>
                                <a class="dropdown-item" href="https://themes.getbootstrap.com/store/webestica/"
                                    target="_blank">
                                    <i class="text-success fa-fw bi bi-cloud-download-fill me-2"></i>Buy Sponsorrs!
                                </a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
