<div class="col-xl-9">
	...
	<div class="card border bg-transparent rounded-3">
		...
		<div class="card-header bg-transparent border-bottom">
			<h3 class="mb-0">Sponsorships List</h3>
		</div>
		<!-- Card header END -->
			...
			<div class="row g-3 align-items-center justify-content-between mb-1">
				...
				<div class="col-md-6" id="noContentFound">
					<p class="bg-info-subtle rounded text-black p-2 d-inline-flex p-2 ">
						<i class="bi bi-exclamation-circle-fill align-middle" style="margin-right: 20px;"></i>Your all
						sponsorships will be show bellow
					</p>
				</div>
				<!-- Select option -->
