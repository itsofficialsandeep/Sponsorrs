...
$weekAmount = $weekResultsAssoc['amount'];
...
$monthAmount = $monthResultsAssoc['amount'];
...
$yearAmount = $yearResultsAssoc['amount'];
...
$totalAmount = $totalResultsAssoc['amount'];

//echo $monthResultsAmount['amount'] . '--' . $yearResultsAmount['amount'] . '--' . $weekResultsAmount['amount'] . '--' . $totalResultsAmount['amount'];
	...
	<div class="row ">
		...
		<div class="col-sm-6 col-lg-4">
			<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
				...
				<div class="ms-4">
					...
					<span class="mb-0 h6 fw-light">Total requests recieved</span>
				</div>
			</div>
		</div>
		<!-- Counter item -->
		<div class="col-sm-6 col-lg-4">
			<div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
				<span class="display-6 text-purple mb-0"><i class="bi bi-send-fill"></i></span>
				<div class="ms-4">
					<div class="d-flex">
						<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0"
		...
		<div class="col-sm-6 col-lg-4">
			<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-10 rounded-3">
				<span class="display-6 text-danger mb-0"><i class="bi bi-youtube"></i></span>
				<div class="ms-4">
					<div class="d-flex">
						<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0"
							data-purecounter-end="<?php echo basicStat($conn, "total_creators", $currentUser); ?>"
							data-purecounter-delay="300">0</h5>

					</div>
					<span class="mb-0 h6 fw-light">Creator you apporached</span>
				</div>
			</div>
		</div>
		<!-- </div> -->
		...
		<div class="col-sm-6 col-lg-4">
			<div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
				...
				<div class="ms-4">
					...
					<span class="mb-0 h6 fw-light">Following Creators(s)</span>
				</div>
			</div>
		</div>
