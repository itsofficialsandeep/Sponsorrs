...
<script>
  ...
  <title>Sponsorrs - Sponsorships for youtube channels</title>

  <!-- Meta Tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="author" content="Webestica.com">
  <meta name="description" content="Sponsorrs - Plaform for Content Creators ">
...
<body>
  ...
  <main>
    ...
    <section class="bg-info bg-opacity-25 position-relative">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 px-md-5 text-center position-relative order-md-2 mb-5 mb-md-0">
                ...
                <figure class="position-absolute top-0 start-0">
                  <img width="27px" height="27px" src="assets/images/flaticon/super-8.png">
                </figure>

                <!-- png decoration -->
                <figure class="position-absolute top-0 start-50 translate-middle mt-n6 d-none d-md-block">
                  <img width="27px" height="27px" src="assets/images/flaticon/abstract-shape.png">
                </figure>

                <!-- png decoration -->
                <figure class="position-absolute top-10 end-0 translate-right mt-n10 d-md-block">
                  <img width="27px" height="27px" src="assets/images/flaticon/microphone.png">
                </figure>


                <!-- Title -->
                <h1 class="mb-3">Search creators to sponsor your brand..</h1>
                <p class="mb-3 d-none">e.g. "Dhruv Rathee"</p>

                <!-- Search -->
                <form class="bg-body rounded p-2" action="search.php?searchtype=creators&" method="get">
                  <div class="input-group">
                    <input class="form-control border-0 me-1" type="text"
                      placeholder="Search creators.. e.g. 'Dhruv Rathee'" name="query" value="">
                    <input type="hidden" name="searchtype" value="creators" />
                    <input type="submit" class="btn btn-dark mb-0 rounded">
                  </div>
                </form>
              </div>
      ...
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Recently added content creators for your brand..</h3>
        ...
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              data-items="5" data-items-lg="3" data-items-sm="1">

              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, "any", 10, $_SESSION['currentUser']); ?>
    ...
    <!--Trending START -->
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        <!-- Title -->
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Showcase your business to business audiences</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 1, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Reach to specific group of people with these vloggers</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 2, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Do you sell something educational? they will help you.</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 3, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Reach people passionate with photography & videography.</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 4, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Do you build gaming products they will help you sell..</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 5, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Reach fitness freak audience.</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 6, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Making political compaign? </h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 7, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Do you organise paid events? </h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 8, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Sell personal care kits to your audince</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 9, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Selling something "experimental"?</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 10, 10, $_SESSION['currentUser']); ?>
        ...
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 11, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Have restaurents or hotels get you foodie audince?</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 12, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-1 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h3>Reach your fashion freak audience..</h3>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="pb-2 tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <?php $suggest = new suggest();
              $suggest->suggestYoutubeCreator($conn, 13, 10, $_SESSION['currentUser']); ?>
        ...
        <div class="row g-4">
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=0"
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=1" class="stretched-link">Finance</a>
              </h6>
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=2" class="stretched-link">Vlogging</a>
              </h6>
              <h7 class="d-none mb-0">15 brands</h7>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=3"
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=4"
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=5" class="stretched-link">Gaming</a>
              </h6>
              <h7 class="d-none mb-0">15 brands</h7>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=6" class="stretched-link">Fitness</a>
              </h6>
              <h7 class="d-none mb-0">15 brands</h7>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=7" class="stretched-link">Politics</a>
              </h6>
              <h7 class="d-none mb-0">15 brands</h7>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=8" class="stretched-link">Comedy
                  Shows</a></h6>
              <h7 class="d-none mb-0">15 brands</h7>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=9" class="stretched-link">Makeup</a>
              </h6>
              <h7 class="d-none mb-0">15 brands</h7>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=10"
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=12" class="stretched-link">Food</a>
              </h6>
              <h7 class="d-none mb-0">15 brands</h7>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-2">
            <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
              ...
              <!-- Title -->
              <h6 class="mb-2"><a href="search.php?searchtype=creators&adcategory=13" class="stretched-link">Clothe</a>
              </h6>
              <h7 class="d-none mb-0">15 brands</h7>
            </div>
          </div>
        ...
        <div class="row g-4">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
              ...
              <h5 class="mb-0"><a href="search.php?searchtype=creators&language=hindi"
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
              ...
              <h5 class="mb-0"><a href="search.php?searchtype=creators&language=english"
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
              ...
              <h5 class="mb-0"><a href="search.php?searchtype=creators&language=spanish"
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Flag_of_Portugal.svg/600px-Flag_of_Portugal.svg.png?20210806190400"
                class="me-3 h-40px" alt="">
              <h5 class="mb-0"><a href="search.php?searchtype=creators&language=portuguese"
  ...
  <!-- =======================Footer START -->
  <footer class="pt-5 bg-light d-none">
    <div class="container">
      <!-- Row START -->
      <div class="row g-4">
