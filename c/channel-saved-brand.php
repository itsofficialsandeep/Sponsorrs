<div class="col-xl-9">
	...
	<div class="card border bg-transparent rounded-3">
		...
		<div class="card-header bg-transparent border-bottom">
			<h3 class="mb-0">Brands you have Saved</h3>
		</div>
		<!-- Card header END -->
		...
		<div class="card-body">
			...
			<div class="row g-3 align-items-center justify-content-between mb-4">
				<!-- Search -->
				<div class="col-md-8">
					<form class="rounded position-relative" id="saved-brand-searchbar-form">
						<input class="form-control pe-5 bg-transparent" type="search"
							placeholder="Search by brand name.." aria-label="Search" id="saved-brand-searchbar">
						<button
							class="bg-transparent p-2 position-absolute top-50 end-0 translate-middle-y border-0 text-primary-hover text-reset"
							type="submit" id="saved-brand-searchbar-button">
				...
				<div class="col-md-3">
					<!-- Short by filter -->
					<form id="saved-brand-filter-form">
						<select class="form-select js-choice border-0 z-index-9 bg-transparent"
							aria-label=".form-select-sm" id="saved-brand-filter-option">
				...
				<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
					...
					<thead>
						<tr>
							...
							<th scope="col" class="border-0">Active sponsorships</th>
							<th scope="col" class="border-0 rounded-end">Action</th>
						</tr>
					</thead>

					<!-- Table body START -->
					<tbody id="saved-brand-response-area">
						<!-- Table item -->
					</tbody>
					<!-- Table body END -->
				</table>
			...
			<div class="d-sm-flex justify-content-sm-center align-items-sm-center mt-4 mt-sm-3">
				<button class="border border-primary bg-primary p-2 rounded text-white" id="saved-brand-load-more">Load
					More</button>
			</div>
			<!-- Pagination END -->
		</div>
