...
<!-- coming-soon.html  11 Feb 2023 14:25:13 GMT -->
			...
			<div class="container position-relative">
				<div class="row g-5 align-items-center justify-content-center">
					<div class="col-lg-5">
						...
						<!-- info -->
						<p>Hey you! Sponsorrs is coming. We are doing our best to launch our website and we will be back
							soon.</p>
						<!-- Progress bar -->
						<div class="overflow-hidden mt-4">
							<p class="mb-1 h6 fw-light text-start">Launch progress</p>
							<div class="progress progress-md progress-percent-bg bg-light">
								<div class="progress-bar progress-bar-striped bg-blue aos" data-aos="slide-right"
					...
					<div class="col-lg-7 text-center">
						<!-- Image -->
						<img src="assets/images/element/coming-soon.svg"
							class="h-300px h-sm-400px h-md-500px h-xl-700px" alt="">
					</div>
				</div>
			</div>
		</section>
