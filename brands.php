...
<body>
  ...
  <main>
    ...
    <section class="bg-warning bg-opacity-25 position-relative">
          ...
          <div class="col-12">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 px-md-5 text-center position-relative order-md-2 mb-5 mb-md-0">
                ...
                <!-- Title -->
                <h1 class="mb-3">Find brands that suit your creativity and content..</h1>
                ...
                <form class="bg-body rounded p-2" action="search.php?searchtype=creators&" method="get">
                  <div class="input-group">
                    ...
                    <input type="submit" class="btn btn-warning mb-0 rounded">
                  </div>
                </form>
              </div>
      ...
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="fs-2">Recently added brands for your growth..</h2>
        ...
        <div class="row">
          ...
          <div class="tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              data-items="4" data-items-lg="3" data-items-sm="1">
    ...
    <section class="pb-5 pt-0 pt-lg-5 d-none">
      <div class="container">
        <!-- Title -->
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="fs-2">Latest brands in finance industry..</h2>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <!-- card item -->
              <?php $suggest = new suggest();
              $suggest->suggestBrands($conn, 5, 10, $_SESSION['currentUser']); ?>
    ...
    <section class="pb-5 pt-0 pt-lg-5 d-none">
      <div class="container">
        ...
        <div class="row mb-4">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="fs-2">Brands in education industry</h2>
            <p class="mb-0" style="display: none;">Check out most 🔥 in the market</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="tiny-slider arrow-round arrow-blur arrow-hover">
            <div class="tiny-slider-inner pb-1" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false"
              ...
              <!-- card item -->
              <?php $suggest = new suggest();
              $suggest->suggestBrands($conn, 6, 10, $_SESSION['currentUser']); ?>
          ...
          for ($i = 0; $i < 26; $i++) {
            ...
            echo '<div class="col-sm-6 col-md-4 col-xl-3 col-lg-3" >
                    <div class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-2">
                      ...
                      <!-- Title -->
                      <h6 class="mb-2"><a href="search.php?searchtype=brands&industry=' . $i . '"
        ...
        <div class="row g-4">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
              ...
              <h5 class="mb-0"><a href="search.php?searchtype=brands&language=hindi"
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
              ...
              <h5 class="mb-0"><a href="search.php?searchtype=brands&language=english"
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
              ...
              <h5 class="mb-0"><a href="search.php?searchtype=brands&language=spanish"
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
              ...
              <h5 class="mb-0"><a href="search.php?searchtype=brands&language=portuguese"
