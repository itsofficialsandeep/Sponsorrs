...
<body class="hold-transition skin-green sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper" style="margin-left: 0px;">
      ...
      $sql = "SELECT * FROM sponsorships INNER JOIN company ON job_post.id_company=company.id_company WHERE sponsorship_id='$_GET[id]'";
                      ...
                      <div class="row">
                        <div class="col-md-9 bg-white padding-2">
                          ...
                          if (isset($_SESSION["id_user"]) && empty($_SESSION['companyLogged'])) { ?>
                                <div>
                                  <a href="misc/apply.php?id=<?php echo $row['sponsorship_id']; ?>"
