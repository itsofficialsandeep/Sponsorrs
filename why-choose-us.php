			...
			<div class="container-fluid">
				<div class="row g-4 g-md-5 align-items-center justify-content-between	mb-xxl-n7">
						...
						<div class="row g-md-5 align-items-center ms-n6">
							...
							<div class="col-6 position-relative">
								...
								<img src="assets/images/element/17.svg"
									class="h-60px position-absolute top-0 start-0 ms-3 mt-n3" alt="">
					...
					<div class="col-lg-6 col-xl-4 col-xxl-5 text-center position-relative">
						...
						<p>Online learning and teaching marketplace with 5K+ courses & 10M students. Taught by experts
							to help you acquire new skills.</p>

						<!-- Buttons -->
						<div class="d-sm-flex align-items-center justify-content-center">
							<!-- Button -->
							<a href="#" class="btn btn-lg btn-warning me-2 mb-4 mb-sm-0">View Courses<i
							...
							<div class="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
								<a data-glightbox data-gallery="office-tour"
									...
									<h6
										class="mb-0 ms-2 fw-normal position-absolute start-100 top-50 translate-middle-y">
										Watch video</h6>
								</a>
							</div>
						</div>
					...
					<div class="col-lg-3 col-xl-4 col-xxl-3">
						<div class="row g-4 align-items-center me-n4">
							...
							<div class="col-5 position-relative">
								...
								<!-- Content -->
								<div
									class="p-3 card card-body shadow position-absolute top-0 start-0 translate-middle z-index-1 d-none d-xxl-block mt-6 ms-n7">
									<div class="d-flex justify-content-between align-items-center">
										...
										<!-- Info -->
										<h6 class="mb-0 small mb-0 ms-3">Over 1M Students have given a five star review
											to their tutors</h6>
									</div>
								</div>
							</div>
			...
			<div class="container">
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4">
						...
						<p class="mb-0">Comfort reached gay perhaps chamber his six detract besides add. Moonlight
					...
					<div class="col-sm-6 col-lg-4">
						<div class="card card-body bg-light p-4 h-100">
							...
							<h5>Online Course From Experts</h5>
					...
					<div class="col-sm-6 col-lg-4">
						<div class="card card-body bg-light p-4 h-100">
							...
							<p class="mb-0">Switching city steps Might rung line what Mr Bulk; Was or between towards
								the have phase.</p>
						</div>
					</div>
					...
					<div class="col-sm-6 col-lg-4">
						<div class="card card-body bg-light p-4 h-100">
							...
							<h5>Over 500+ High Quality Courses</h5>
				...
				<div class="row g-4">
						...
						<div class="card p-2 shadow h-100">
							<div class="card-image-scale rounded-3 position-relative">
								...
								<div class="card-img-overlay d-flex flex-column p-2 z-index-1">
									<div><span class="badge text-bg-dark"><i
												class="bi bi-star-fill text-warning me-2"></i>4.3</span></div>
								</div>
							</div>
							...
							<div class="card-body px-2">
								<!-- Title -->
								<h5 class="card-title"><a href="workshop-detail.html" class="stretched-link">Build your
										brand & business</a></h5>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card p-2 shadow h-100">
							<div class="card-image-scale rounded-3 position-relative">
								<!-- Card Image -->
								<img src="assets/images/instructor/02.jpg" class="card-img" alt="">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-2 z-index-1">
									<div><span class="badge text-bg-dark"><i
												class="bi bi-star-fill text-warning me-2"></i>4.5</span></div>
								</div>
							</div>
							...
							<div class="card-body px-2">
								<!-- Title -->
								<h5 class="card-title"><a href="workshop-detail.html" class="stretched-link">Master in
										logo design</a></h5>
								<h6 class="mb-0 fw-normal">With Jacqueline Miller</h6>
							</div>
						</div>
					</div>
					<!-- Card item END -->
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card p-2 shadow h-100">
							<div class="card-image-scale rounded-3 position-relative">
								<!-- Card Image -->
								<img src="assets/images/instructor/03.jpg" class="card-img" alt="">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-2 z-index-1">
									<div><span class="badge text-bg-dark"><i
												class="bi bi-star-fill text-warning me-2"></i>4.8</span></div>
								</div>
							</div>
							...
							<div class="card-body px-2">
								<!-- Title -->
								<h5 class="card-title"><a href="workshop-detail.html" class="stretched-link">Create
										brand using vector illustration</a></h5>
								<h6 class="mb-0 fw-normal">With Louis Ferguson</h6>
							</div>
						</div>
					</div>
					<!-- Card item END -->
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card p-2 shadow h-100">
							<div class="card-image-scale rounded-3 position-relative">
								<!-- Card Image -->
								<img src="assets/images/instructor/06.jpg" class="card-img" alt="">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-2 z-index-1">
									<div><span class="badge text-bg-dark"><i
												class="bi bi-star-fill text-warning me-2"></i>4.2</span></div>
								</div>
							</div>
							...
							<div class="card-body px-2">
								<!-- Title -->
								<h5 class="card-title"><a href="workshop-detail.html" class="stretched-link">Develop
										your marketing skills style</a></h5>
								<h6 class="mb-0 fw-normal">With Frances Guerrero</h6>
							</div>
						</div>
					</div>
					<!-- Card item END -->
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card p-2 shadow h-100">
							<div class="card-image-scale rounded-3 position-relative">
								<!-- Card Image -->
								<img src="assets/images/instructor/07.jpg" class="card-img" alt="">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-2 z-index-1">
									<div><span class="badge text-bg-dark"><i
												class="bi bi-star-fill text-warning me-2"></i>4.8</span></div>
							...
							<div class="card-body px-2">
								<!-- Title -->
								<h5 class="card-title"><a href="workshop-detail.html" class="stretched-link">Build your
										own responsive website</a></h5>
								<h6 class="mb-0 fw-normal">With Amanda Reed</h6>
							</div>
						</div>
					</div>
					<!-- Card item END -->
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card p-2 shadow h-100">
							<div class="card-image-scale rounded-3 position-relative">
								<!-- Card Image -->
								<img src="assets/images/instructor/08.jpg" class="card-img" alt="">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-2 z-index-1">
									<div><span class="badge text-bg-dark"><i
												class="bi bi-star-fill text-warning me-2"></i>4.7</span></div>
								</div>
							</div>
							...
							<div class="card-body px-2">
								<!-- Title -->
								<h5 class="card-title"><a href="workshop-detail.html" class="stretched-link">Become a
										professional product photographer</a></h5>
								<h6 class="mb-0 fw-normal">With Samuel Bishop</h6>
							</div>
						</div>
					</div>
					<!-- Card item END -->
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card p-2 shadow h-100">
							<div class="card-image-scale rounded-3 position-relative">
								<!-- Card Image -->
								<img src="assets/images/instructor/10.jpg" class="card-img" alt="">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-2 z-index-1">
									<div><span class="badge text-bg-dark"><i
												class="bi bi-star-fill text-warning me-2"></i>4.9</span></div>
								</div>
							</div>
							...
							<div class="card-body px-2">
								<!-- Title -->
								<h5 class="card-title"><a href="workshop-detail.html" class="stretched-link">Developed
										your photo editing skills</a></h5>
								<h6 class="mb-0 fw-normal">With Lori Stevens</h6>
							</div>
						</div>
					</div>
					<!-- Card item END -->
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card p-2 shadow h-100">
							<div class="card-image-scale rounded-3 position-relative">
								<!-- Card Image -->
								<img src="assets/images/instructor/11.jpg" class="card-img" alt="">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-2 z-index-1">
									<div><span class="badge text-bg-dark"><i
												class="bi bi-star-fill text-warning me-2"></i>4.0</span></div>
								</div>
							</div>
							...
							<div class="card-body px-2">
								<!-- Title -->
								<h5 class="card-title"><a href="workshop-detail.html" class="stretched-link">Master logo
										design</a></h5>
								<h6 class="mb-0 fw-normal">With Joan Wallace</h6>
							</div>
						</div>
					</div>
					<!-- Card item END -->
								...
								<div class="col-md-6">
									<form class="bg-body rounded-2 p-2">
										<div class="input-group">
											...
											<button type="button"
												class="btn btn-blue mb-0 rounded-2">Subscribe!</button>
										</div>
									</form>
								</div>
							</div> <!-- Row END -->
						...
						<div class="tiny-slider-inner pb-1" data-autoplay="true" data-arrow="true" data-edge="2"
							...
							<div>
								<div class="card border bg-transparent h-100">
									...
									<div class="card-body">
										<!-- Title -->
										<h5 class="card-title fw-normal"><a href="course-detail.html"
												class="stretched-link">Sketch from A to Z: for app designer</a></h5>
							...
							<div>
								<div class="card border bg-transparent h-100">
									<!-- Image -->
									<img src="assets/images/courses/4by3/02.jpg" class="card-img-top"
										alt="course image">
									<!-- Card body -->
									<div class="card-body">
										<!-- Title -->
										<h5 class="card-title fw-normal"><a href="course-detail.html"
												class="stretched-link">Graphic Design Masterclass</a></h5>
										<div class="d-sm-flex justify-content-between align-items-center">
							...
							<div>
								<div class="card border bg-transparent h-100">
									<!-- Image -->
									<img src="assets/images/courses/4by3/03.jpg" class="card-img-top"
										alt="course image">
									<!-- Card body -->
									<div class="card-body">
										<!-- Title -->
										<h5 class="card-title fw-normal"><a href="course-detail.html"
												class="stretched-link">Create a Design System in Figma</a></h5>
										<div class="d-sm-flex justify-content-between align-items-center">
							...
							<div>
								<div class="card border bg-transparent h-100">
									<!-- Image -->
									<img src="assets/images/courses/4by3/11.jpg" class="card-img-top"
										alt="course image">
									<!-- Card body -->
									<div class="card-body">
										<!-- Title -->
										<h5 class="card-title fw-normal"><a href="course-detail.html"
												class="stretched-link">Build Responsive Websites with HTML</a></h5>
										<div class="d-sm-flex justify-content-between align-items-center">
							...
							<div>
								<div class="card border bg-transparent h-100">
									<!-- Image -->
									<img src="assets/images/courses/4by3/06.jpg" class="card-img-top"
										alt="course image">
									<!-- Card body -->
									<div class="card-body">
										<!-- Title -->
										<h5 class="card-title fw-normal"><a href="course-detail.html"
												class="stretched-link">Build Responsive Websites with Angular</a></h5>
										<div class="d-sm-flex justify-content-between align-items-center">
											<h6 class="mb-0">Larry Lawson</h6>
											<a href="#" class="btn btn-link p-0 mb-0">View detail<i
													class="bi bi-arrow-right ms-2"></i></a>
			...
			<div class="container">
				<div class="row g-4">
					...
					<div class="col-lg-6 col-xl-5">
						...
						<p class="mb-0">We are answering the most frequent questions. No worries if you do not find the
							exact one. You can find out more by searching or continuing by clicking the button below or
							directly <a href="#" class="text-decoration-underline">Contact our supports</a></p>
					</div>
						...
						<div class="accordion accordion-icon accordion-bg-light" id="accordionFaq">
							...
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingOne">
									<button class="accordion-button h6 rounded" type="button" data-bs-toggle="collapse"
							...
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingTwo">
									<button class="accordion-button h6 rounded collapsed" type="button"
							...
							<div class="accordion-item">
								...
								<div id="collapseThree" class="accordion-collapse collapse"
									...
									<div class="accordion-body">
										...
										domestic. Sight house has sex never. No visited raising gravity outward subject
										my cottage Mr be.
									</div>
								</div>
							</div>
							...
							<div class="accordion-item">
								...
								<div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
									data-bs-parent="#accordionFaq">
									<div class="accordion-body">
										But her ready least set lived spite solid. September how men saw tolerably two
										behavior arranging. She offices for highest and replied one venture pasture.
										Applauded no discovery in newspaper allowance am northward. Frequently
										partiality possession resolution at or appearance unaffected me. Engaged its was
										the evident pleased husband. Ye goodness felicity do disposal dwelling no. First
										am plate jokes to began to cause a scale. Subjects he prospect elegance followed
										no overcame possible it on. Improved own provided blessing may peculiar
										domestic. Sight house has sex never. No visited raising gravity outward subject
										my cottage Mr be. Hold do at tore in park feet near my case. Invitation at
										understood occasional sentiments insipidity inhabiting in. Off melancholy
										alteration principles old. Is do speedily kindness properly oh. Respect article
										painted cottage he is offices parlors.
									</div>
								</div>
							</div>
						</div>
