                ...
                <div class="col-md-12">
                  <div class="box-body table-responsive no-padding">
                    <table id="example2" class="table table-hover">
                      ...
                      <tbody>
                        <?php
                        $sql = "SELECT * FROM sponsorships WHERE id_company='$_SESSION[id_company]'";
                        ...
                        if ($result->num_rows > 0) {
                          while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                              <td>
                                <?php echo $row['sponsorship_title']; ?>
                              </td>
                              <!--- <td><a href="view-job-post.php?id=<?php echo $row['sponsorship_id']; ?>"><i class="fa fa-address-card-o"></i></a></td> -->
                              <td><a href="edit-job-post.php?id=<?php echo $row['sponsorship_id']; ?>">View/Edit</a></td>
                            </tr>
                            <?php
                          }
                        }
