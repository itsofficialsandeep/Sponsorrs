                ...
                <form method="post" action="addpost.php">
                  <div class="col-md-12 latest-job ">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control input-lg form-select" name="location" id="location">
                        ...
                        <option value="7">Political Satire</option>
                    ...
                    <div class="form-group">
                      <label for="country" class="form-label">Offer Price </label>
                    ...
                    <div class="form-group" style="display: none;">
                      <input type="number" class="form-control  input-lg" id="offer_price" name="offer_price"
                        placeholder="Maximum Salary" required="" value="1">
                    </div>
                    <div class="form-group" style="display: none;">
