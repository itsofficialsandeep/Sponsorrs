...
$sql = "SELECT * FROM apply_sponsorships WHERE id_company='$_SESSION[id_company]' AND id_user='$_GET[id]'";
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <div>
                        ...
                        echo '<br>';
                        if ($row['resume'] != "") {
                          echo '<a href="../uploads/resume/' . $row['resume'] . '" class="btn btn-info" download="Resume" style="display:none">Download Resume</a>';
                        }
                        echo '<br>';
                        echo '<br>';
                        echo '<br>';
                        ...
                        <div class="row">
                          <div class="col-md-3 pull-left">
                            <a href="under-review.php?id=<?php echo $row['id_user']; ?>&sponsorship_id=<?php echo $_GET['sponsorship_id']; ?>"
                              class="btn btn-success">Mark Under Review</a>
                          </div>
                          <div class="col-md-3 pull-left">
                            <a href="reject.php?id=<?php echo $row['id_user']; ?>&sponsorship_id=<?php echo $_GET['sponsorship_id']; ?>"
