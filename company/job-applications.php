        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              <?php
              $sql = "SELECT * FROM sponsorships INNER JOIN apply_sponsorships ON job_post.sponsorship_id=apply_job_post.sponsorship_id  INNER JOIN users ON users.id_user=apply_job_post.id_user WHERE apply_job_post.id_company='$_SESSION[id_company]'";
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  <div class="attachment-block clearfix padding-2">
                    <h4 class="attachment-heading"><a
                        href="user-application.php?id=<?php echo $row['id_user']; ?>&sponsorship_id=<?php echo $row['sponsorship_id']; ?>"><?php
                              echo $row['sponsorship_title'] . ' @ (' . $row['firstname'] . ' ' . $row['lastname'] . ')'; ?></a>
                    </h4>
