        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              <?php
              $sql = "SELECT * FROM sponsorships INNER JOIN apply_sponsorships ON job_post.sponsorship_id=apply_job_post.sponsorship_id WHERE apply_job_post.id_user='$_SESSION[id_user]'";
                  ...
                  ?>
                      <div class="attachment-block clearfix padding-2">
                        <h4 class="attachment-heading"><a
                            href="view-job-post.php?id=<?php echo $row['sponsorship_id']; ?>"><?php
                               echo $row['sponsorship_title']; ?></a></h4>
                        <div class="attachment-text padding-2">
                          ...
                          if ($row['status'] == 0) {
                            ...
                            echo '<div class="pull-right"><strong class="text-green">Selected</strong></div> ';
                          }
                          ?>
