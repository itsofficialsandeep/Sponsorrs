...
$sql = "SELECT * FROM apply_sponsorships WHERE id_user='$_SESSION[id_user]' AND sponsorship_id='$_GET[id]'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {

  $sql1 = "SELECT * FROM sponsorships INNER JOIN company ON job_post.id_company=company.id_company WHERE sponsorship_id='$_GET[id]'";
